...
_FORWARDEXTRA = DESCRIPTOR.message_types_by_name['ForwardExtra']
_PICREC = DESCRIPTOR.message_types_by_name['PicRec']
_MARKETFACEREC = DESCRIPTOR.message_types_by_name['MarketFaceRec']
_MSG = DESCRIPTOR.message_types_by_name['Msg']
_ELEM = DESCRIPTOR.message_types_by_name['Elem']
_SAFEMOREINFO = DESCRIPTOR.message_types_by_name['SafeMoreInfo']
