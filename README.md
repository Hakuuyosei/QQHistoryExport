...
您需要准备一台windows电脑，在release里下载软件，然后需要通过root/手机备份的方式拿出手机的QQ数据，移动到电脑上，然后运行本项目。
...
5.数据里最开始一段或者某一段只有撤回消息和时间信息，PDF里面看着全是一大片灰条文字。
...
![image-20230727232553597](README/image-20230727232553597.png)
