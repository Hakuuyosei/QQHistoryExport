...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(693, 700)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.parseConfigContainer = QtWidgets.QGroupBox(self.centralwidget)
        self.parseConfigContainer.setGeometry(QtCore.QRect(0, 10, 391, 571))
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(10, 330, 371, 237))
        ...
        self.gridLayout_3.addWidget(self.pttPathSelectButton, 8, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.modeSelectContainer_2, 5, 2, 1, 2)
        self.noNeedDisplaySelectButton = QtWidgets.QCheckBox(self.gridLayoutWidget_3)
        self.noNeedDisplaySelectButton.setEnabled(True)
        self.noNeedDisplaySelectButton.setText("")
        self.noNeedDisplaySelectButton.setChecked(True)
        self.noNeedDisplaySelectButton.setTristate(False)
        self.noNeedDisplaySelectButton.setObjectName("noNeedDisplaySelectButton")
        self.gridLayout_3.addWidget(self.noNeedDisplaySelectButton, 4, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_10, 7, 1, 1, 3)
        self.label_19 = QtWidgets.QLabel(self.gridLayoutWidget_3)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_19.setFont(font)
        self.label_19.setObjectName("label_19")
        self.gridLayout_3.addWidget(self.label_19, 4, 1, 1, 3)
        ...
        self.gridLayout_3.addWidget(self.chatimgPathSelectButton, 6, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chatimgPathInputBox, 6, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.pttPathInputBox, 8, 2, 1, 1)
        ...
        self.QQemojiVerSelectBox = QtWidgets.QCheckBox(self.gridLayoutWidget_3)
        self.QQemojiVerSelectBox.setEnabled(True)
        self.QQemojiVerSelectBox.setText("")
        self.QQemojiVerSelectBox.setChecked(True)
        self.QQemojiVerSelectBox.setTristate(False)
        self.QQemojiVerSelectBox.setObjectName("QQemojiVerSelectBox")
        self.gridLayout_3.addWidget(self.QQemojiVerSelectBox, 5, 0, 1, 1)
        self.useImageSelectButton = QtWidgets.QCheckBox(self.gridLayoutWidget_3)
        self.useImageSelectButton.setEnabled(True)
        self.useImageSelectButton.setText("")
        self.useImageSelectButton.setChecked(False)
        self.useImageSelectButton.setTristate(False)
        self.useImageSelectButton.setObjectName("useImageSelectButton")
        self.gridLayout_3.addWidget(self.useImageSelectButton, 6, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.usePttCheckBox, 8, 0, 1, 1)
        self.needMarketFaceSelectButton = QtWidgets.QCheckBox(self.gridLayoutWidget_3)
        self.needMarketFaceSelectButton.setEnabled(True)
        self.needMarketFaceSelectButton.setText("")
        self.needMarketFaceSelectButton.setChecked(True)
        self.needMarketFaceSelectButton.setTristate(False)
        self.needMarketFaceSelectButton.setObjectName("needMarketFaceSelectButton")
        self.gridLayout_3.addWidget(self.needMarketFaceSelectButton, 10, 0, 1, 1)
        self.label_11 = QtWidgets.QLabel(self.gridLayoutWidget_3)
        self.label_11.setObjectName("label_11")
        self.gridLayout_3.addWidget(self.label_11, 10, 1, 1, 3)
        self.needReplyMsgSelectButton = QtWidgets.QCheckBox(self.gridLayoutWidget_3)
        self.needReplyMsgSelectButton.setEnabled(True)
        self.needReplyMsgSelectButton.setText("")
        self.needReplyMsgSelectButton.setChecked(True)
        self.needReplyMsgSelectButton.setTristate(False)
        self.needReplyMsgSelectButton.setObjectName("needReplyMsgSelectButton")
        self.gridLayout_3.addWidget(self.needReplyMsgSelectButton, 11, 0, 1, 1)
        self.label_14 = QtWidgets.QLabel(self.gridLayoutWidget_3)
        self.label_14.setObjectName("label_14")
        self.gridLayout_3.addWidget(self.label_14, 11, 1, 1, 3)
        self.label_9 = QtWidgets.QLabel(self.gridLayoutWidget_3)
        self.label_9.setObjectName("label_9")
        self.gridLayout_3.addWidget(self.label_9, 9, 1, 1, 2)
        ...
        self.qqSlowtableselectButton2 = QtWidgets.QCheckBox(self.gridLayoutWidget)
        self.qqSlowtableselectButton2.setChecked(True)
        self.qqSlowtableselectButton2.setTristate(False)
        self.qqSlowtableselectButton2.setObjectName("qqSlowtableselectButton2")
        self.gridLayout.addWidget(self.qqSlowtableselectButton2, 1, 0, 1, 2)
        ...
        self.starButton.setGeometry(QtCore.QRect(570, 610, 121, 41))
...
"}")
        ...
        self.label_6.setGeometry(QtCore.QRect(270, 630, 181, 21))
        self.label_6.setObjectName("label_6")
        self.startParseButton = QtWidgets.QPushButton(self.centralwidget)
        self.startParseButton.setGeometry(QtCore.QRect(10, 590, 241, 61))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_18.setText(_translate("MainWindow", "QQ表情版本"))
        self.label_13.setText(_translate("MainWindow", "ptt文件夹"))
        self.label_10.setText(_translate("MainWindow", "聊天图片"))
        self.label_19.setText(_translate("MainWindow", "没选择解析的类型用[xxx]代替，比如[图片]"))
        ...
        self.label_14.setText(_translate("MainWindow", "引用消息的源消息部分"))
        ...
        self.qqSlowtableselectButton2.setText(_translate("MainWindow", "解析两个月以前的聊天记录"))
